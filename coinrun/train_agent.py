...
# import ptvsd
# port=3000
# # ptvsd.enable_attach(secret='cert_gdb_pythoncpp', address =('127.0.0.1', port))
# ptvsd.enable_attach(secret='cert_gdb_pythoncpp')
# #ptvsd.enable_attach()
#
...
def main():
    ...
    env = utils.make_general_env(nenvs, seed='1')

    with tf.Session(config=config):
        #get env
        env = wrappers.add_final_wrappers(env)
        #Get nuralnetwork: CnnPolicy LstmPolicy
